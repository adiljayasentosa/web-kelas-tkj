...
/**
 * Sesuai ui-ux-planning-website-kelas-v1.0.md §5 & §8.3: komponen ini
 * HANYA dipakai di breakpoint md ke atas. Di mobile, data admin (anggota,
 * riwayat kas, dst.) harus dirender sebagai daftar Card, bukan tabel ini
 * — itu keputusan di level halaman fitur, bukan sesuatu yang otomatis
 * ditangani komponen Table ini sendiri.
 */
